      ...
      <main className="w-full flex-1 pt-20 md:pt-24">
        <div className="mx-auto w-full max-w-6xl px-4 md:px-6">
          <div className="mx-auto w-full max-w-3xl">
            <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-linear-to-b from-slate-900/70 to-slate-950/90 shadow-xl">
              <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_top,rgba(248,113,113,0.18),transparent_60%),radial-gradient(circle_at_bottom,rgba(59,130,246,0.2),transparent_55%)]" />
