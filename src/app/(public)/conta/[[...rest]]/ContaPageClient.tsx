          ...
          <div className="text-white">
            ...
            {!isVisitant ? (
              <div className="rounded-2xl border mt-8 border-white/10 bg-black/40 backdrop-blur-sm p-6 md:p-8 space-y-4">
                <div>
                  <p className="text-white/80">
                    Seu ICM ID: <span className="font-semibold text-white">{claims?.public_code}</span>
                  </p>
                  <p className="text-white/80">
                    Cargo:{" "}
              ...
              <div className="space-y-3">
                <p className="text-sm text-white/70">Falta pouco pra liberar tudo da área do membro.</p>
                ...
                <div className="rounded-2xl border border-white/10 bg-black/40 backdrop-blur-sm p-6 md:p-8">
                  <div className="flex items-start justify-between gap-4 mb-5">
                    <div>
                      ...
                      <p className="mt-1 text-sm text-white/70">Preencha os dados abaixo para concluir.</p>
                    </div>
                  </div>
